...
osx_flags = {
    ...
    'depends': ['NokeController.m','AESCipher.py','userClient.py','NokeCallback.m','NokeCallback.h','nokeDevice.h','nokeDevice.m','nokeSDK.h','nokeSDK.m','TI_aes_128.m','TI_aes_128.h']}
