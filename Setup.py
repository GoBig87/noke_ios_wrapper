...
osx_flags = {
    ...
    'depends': ['NokeViewController.m','activityItem.h','activityItem.m','nokeClient.h','nokeClient.m','nokeDevice.h','nokeDevice.m','nokeSDK.h','nokeSDK.m','Reachability.h','Reachability.m','TI_aes_128.m','TI_aes_128.h']}
...
setup(
      name='noke',
      version='0.1',
      description="A simple wrapper for Noke locks",
      classifiers=[
