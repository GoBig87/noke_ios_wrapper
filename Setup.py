...
osx_flags = {
    ...
    'depends': ['NokeViewController.m','activityItem.h','activityItem.m','nokeClient.h','nokeClient.m','nokeDevice.h','nokeDevice.c','nokeSDK.h','nokeSDK.m','Reachability.h','Reachability.m','TI_aes_128.c','TI_aes_128.h']}
